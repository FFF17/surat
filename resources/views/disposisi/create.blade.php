    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <!-- Main content -->   <form action="{{ url('disposisi/create') }}" class="col s12" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                            ...
                            <ul class="timeline">
                                ...
                                <li>
                                    ...
                                    <div class="timeline-item">
                                        <span class="time"><i class="fa fa-clock-o"></i>{{$mail->created_at}}</span>
                                        <h3 class="timeline-header">Mail From: <a href="#"> {{$mail->mail_from}}</a></h3>
                                                                                <h3 class="timeline-header">Mail To: <a href="#"> {{$mail->mail_to}}</a></h3>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="reply_at" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                    </div>
                                         ...
                                         <div class="form-group col-md-4">
                                            ...
                                            <input type="text"  name="notification" class="form-control" placeholder="Enter ..."/>
                                    </div>
                                       ...
                                       <div class="form-group col-md-2 ">
                                            ...
                                            <input type="hidden"  name="user_id" value="{{ Auth::user()->id }}" class="form-control" placeholder="Enter ..."/>
                                        ...
                                        <div class='timeline-footer'>
                                            <a class="btn btn-primary btn-xs">{{$mail->type_mail->type_mail}}</a>
